        ...
        <div className="flex lg:flex-row lg:items-start lg:gap-0 flex-col items-center gap-9">
          <div className="lg:w-[50%] w-[90%] flex flex-col gap-6 ">
            <p>
              ...
              Técnico em Desenvolvimento de Sistemas. Assim que me formei, segui
              direto para a faculdade, cursando Desenvolvimento de Software
            ...
            <p>
              ...
              me apaixonei pelo Front-end e UI/UX. Amo transformar minhas ideias
              em interfaces bonitas, intuitivas e funcionais. Gosto de desenhar
              sistemas, landing pages, ilustrações digitais e artes para o
              instagram (além de ter uma loja de artesanato e expressar minha
              criatividade também no crochê :D).
            </p>
            <p>
